		...
		<div class="w3-bar w3-border w3-black">
			...
			<div class="w3-container">
				<table class="w3-table-all">
					...
					<c:forEach items="${sessionScope.usersAll}" var="data">
						...
						<tr class="w3-hover-black">
							<td>${data.userHeight}</td>
							<td>${data.userWeight}</td>
							<td>${data.purpose}</td>
						</tr>
					</c:forEach>

				</table>
<p><button class="w3-button w3-block w3-red">수정하기</button></p>
			</div>
		...
		<div class="w3-black w3-center w3-padding-24">
			Made by <a href="https://www.w3schools.com/w3css/default.asp"
				title="W3.CSS" target="_blank" class="w3-hover-opacity">박다영,
				박민영, 최지수</a>
		</div>
