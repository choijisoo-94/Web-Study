...
<div class="w3-bar w3-border w3-black">
 ...
 <div class="w3-content w3-section" style="max-width:500px">
  <img class="mySlides" src="${pageContext.request.contextPath}/images/9.jpg" style="width:100%">
  <img class="mySlides" src="${pageContext.request.contextPath}/images/10.png" style="width:100%">
  <img class="mySlides" src="${pageContext.request.contextPath}/images/11.jpg" style="width:100%">
  <img class="mySlides" src="${pageContext.request.contextPath}/images/14.png" style="width:100%">
</div>
...
function carousel() {
  ...
  <div class="w3-center w3-padding-32">
    <div class="w3-bar">
      <a href="video.jsp" class="w3-bar-item w3-button w3-hover-black">«</a>
      <a href="video.jsp" class="w3-bar-item w3-black w3-button">1</a>
      <a href="video2.jsp" class="w3-bar-item w3-button w3-hover-black">2</a>
      <a href="video2.jsp" class="w3-bar-item w3-button w3-hover-black">»</a>
    </div>
  </div>
