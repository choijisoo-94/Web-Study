...
<!-- Photo grid -->
  <div class="w3-row w3-grayscale-min">
   ...
   <a href = "https://www.youtube.com/watch?v=WaWxwZl-U9Q&list=PLW9IOmh5rOAoXmlbOVG34L3nTuFYln8Pe/" height="5" width ="10" target ="_blank">
      <img src="${pageContext.request.contextPath}/images/8.png" style="width:100%" alt = "위의 이미지를 눌러주세요!">
  </a>
   </div>
   
    <div class="centered">
    
   <a href = "https://www.youtube.com/watch?v=zoUe1m8BFd8&list=PLUL8g4XeMfphFiXEFx9uMxAXbU5qKn5PJ/" height="5" width ="10" target ="_blank">
      <img src="${pageContext.request.contextPath}/images/66.png" style="width:100%" alt = "위의 이미지를 눌러주세요!">
  </a>
   </div>
  </div>
