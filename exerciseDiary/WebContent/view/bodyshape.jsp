...
<!-- Photo grid -->
  <div class="w3-row w3-grayscale-min">
    ...
    <div class="centered">
   	<a href = "https://www.youtube.com/watch?v=vQNFiMi0m9M&list=PL59wN1Mv0vQe5e31bDp_3vLKKphkHls9L/" height="5" width ="10" target ="_blank">
      <img src="${pageContext.request.contextPath}/images/6.png" style="width:100%" alt = "위의 이미지를 눌러주세요!">
  </a>
   </div>
   
    <div class="centered">
   
      <a href = "https://www.youtube.com/watch?v=qMtyhDDmJ-U&list=PLA92lMlT0Ro8cSRvUeegs1_YwJWz8hR01/" height="5" width ="10" target ="_blank">
      <img src="${pageContext.request.contextPath}/images/7.png" style="width:100%" alt = "위의 이미지를 눌러주세요!">
  </a>
   </div>
  </div>
