...
<body class="w3-light-grey">
	...
	<div class="w3-main w3-content"
		...
		<form action="/action_page.php" class="w3-container w3-card-4 w3-light-grey w3-text-purple w3-margin">
<h2 class="w3-center">New Diary</h2>
 
<div class="w3-row w3-section">
    <div class="w3-rest">
      <input class="w3-input w3-border" name="제목" type="text" placeholder="제목">
    </div>
</div>

<select class="w3-select" name="option">
 <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-user"></i></div>
    <option value="" disabled selected>운동했던 영상 검색</option>
    <option value="1">다이어트 - 다노 TV</option>
    <option value="2">다이어트 - 에이핏</option>
    <option value="3">근육량 증가 - 말왕</option>
    <option value="4">근육량 증가 - 지피티</option>
    <option value="5">체형 교정 - 힙으뜸</option>
    <option value="6">체형 교정 - 피지컬갤러리</option>

  </select>

<div class="w3-row w3-section">
    <div class="w3-rest">
      <input class="w3-input w3-border" name="세부사항" type="text" placeholder="영상 세부 제목 작성">
    </div>
</div>

<div class="w3-row w3-section">
    <div class="w3-rest">
      <input class="w3-input w3-border" name="오늘의 체중" type="text" placeholder="오늘의 체중">
    </div>
</div>
...
<div class="w3-row w3-section">
    <div class="w3-rest">
      <input class="w3-input w3-border" name="message" type="text" placeholder="다이어리 내용">
    </div>
</div>



<button class="w3-button w3-block w3-section w3-purple w3-ripple w3-padding">UPLOAD</button>
