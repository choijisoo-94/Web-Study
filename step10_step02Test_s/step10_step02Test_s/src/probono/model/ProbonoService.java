...
public class ProbonoService {
	...
	public static ArrayList<ActivistDTO> getAllActivists() throws SQLException, NotExistException{
		ArrayList<ActivistDTO> activistAll = ActivistDAO.getAllActivists();
		if(activistAll == null) {
			System.out.println("g333");
			throw new NotExistException("재능 기부자가 미 존재합니다.");
		}
		return activistAll;
	}
